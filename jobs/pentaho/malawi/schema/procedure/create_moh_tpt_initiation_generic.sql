...
insert into moh_tpt_initiation(district,age_group,gender,tx_new,tx_new_eligible_tpt,new_start_three_hp,previous_start_three_hp,new_start_six_h,previous_start_six_h)
...
from hiv_cohort where  
	((case 
	 ...
	 end) and (first_inh_300 is not null or first_rfp_150 is not null or first_rfp_inh is not null)
